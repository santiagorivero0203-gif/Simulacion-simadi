...
nuevas = [
  ...
  },
  {
    "area": "Razonamiento Lógico",
    "tema": "Criptoaritmética",
    "pregunta": "En un sistema de encriptación, las consonantes de una palabra se ignoran y cada vocal tiene un valor específico. Si sabemos que PIÑA = 14 y que GATO = 16, ¿cuál es el valor numérico de la palabra BOINA?",
    "opciones": ["30", "14", "16", "20"],
    "correcta": "30",
    "justificacion": "PIÑA = I + A = 14. GATO = A + O = 16. BOINA = O + I + A. Sabemos que I + A = 14, pero no tenemos el valor exacto de O de manera individual. Sin embargo, si sumamos ambas ecuaciones (I+A) + (A+O) = 30. No es directo. Un momento, hagamos esto: I+A=14, A+O=16. BOINA = O+I+A. Faltaría A para sumar. Corrijamos: si MESA = E+A=12, PISO = I+O=15, POESIA = O+E+I+A = (E+A) + (I+O) = 12 + 15 = 27.",
    # Voy a corregir la pregunta programáticamente antes de guardar.
  },
  {
    "area": "Razonamiento Lógico Numérico",
    "tema": "Porcentajes",
  ...
  },
  {
    "area": "Razonamiento Lógico Numérico",
    "tema": "Edades",
    "pregunta": "La suma de las edades de Juan y Alberto es 40 años. Cuando Pedro nació, Alberto tenía 4 años, y Juan le lleva 6 años a Pedro. ¿Cuál es la edad actual de Alberto?",
    "opciones": ["20", "15", "25", "18"],
    "correcta": "15",
    "justificacion": "Alberto tenía 4 años al nacer Pedro, es decir, A = P + 4. Juan le lleva 6 a Pedro, J = P + 6. J + A = 40. (P + 6) + (P + 4) = 40 -> 2P + 10 = 40 -> 2P = 30 -> P = 15. Entonces, la edad de Alberto es A = 15 + 4 = 19. (Espera, las opciones no coinciden. Reescribiré esto programáticamente)."
  },
  {
    "area": "Razonamiento Lógico Numérico",
    "tema": "Promedios",
...
# Corrección de las preguntas equivalentes antes de exportar
nuevas[1]['pregunta'] = "En un sistema de encriptación, las consonantes se ignoran y cada vocal tiene un valor específico. Si sabemos que MESA = 12 y que PISO = 15, ¿cuál es el valor numérico de la palabra POESIA?"
nuevas[1]['opciones'] = ["20", "27", "22", "30"]
nuevas[1]['correcta'] = "27"
nuevas[1]['justificacion'] = "MESA = E + A = 12. PISO = I + O = 15. POESIA = O + E + I + A. Reordenando, esto es igual a (E + A) + (I + O). Por lo tanto, 12 + 15 = 27."

nuevas[5]['pregunta'] = "La suma de las edades de Juan y Alberto es 35 años. Cuando Pedro nació, Alberto tenía 5 años, y Juan le lleva 6 años a Pedro. ¿Cuál es la edad actual de Alberto?"
nuevas[5]['opciones'] = ["15", "17", "18", "20"]
nuevas[5]['correcta'] = "17"
nuevas[5]['justificacion'] = "A = P + 5, J = P + 6. J + A = 35. (P + 6) + (P + 5) = 35 -> 2P + 11 = 35 -> 2P = 24 -> P = 12. La edad de Alberto es A = 12 + 5 = 17."

todas = preguntas + nuevas

with open('c:/Users/user/Desktop/video proyectos/Simulacion simadi/scratch/lote1.json', 'w', encoding='utf-8') as f:
